Drop database Campus_Eats_Fall2021; 
Create database Campus_Eats_Fall2021;
Use Campus_Eats_Fall2021;
...
CREATE TABLE IF NOT EXISTS `campus_eats_fall2021`.`menu` (
  ...
  INDEX `fk_menu_idx` (`restaurant_id` ASC) VISIBLE,
  CONSTRAINT `fk_menu`
    FOREIGN KEY (`restaurant_id`)
    REFERENCES `campus_eats_fall2021`.`restaurant` (`restaurant_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

INSERT INTO menu values(1,20,'South Indian Breakfast','Rava Dosa',2),
(2,45,'South Indian Breakfast','Idly',1),
(3,23,'South Indian Breakfast','Vada',1),
(4,45,'North Indian Breakfast','Paratha',2),
(5,78,'North Indian Breakfast','Roti',2),
(6,89,'North Indian Dish','Naan',2),
(7,78,'lentil Soup','Sambar',3),
(8,34,'Pepper Soup','Rasam',3),
(9,56,'North Indian Breakfast','Poha',3),
(10,45,'Yogurt','Curd',4),
(11,30,'Western Food','Bun',4),
(12,20,'Dessert','Cake',4),
(13,20,'South Indian Breakfast','Dosa',5),
(14,68,'Dessert','Badushah',5),
(15,70,'Dessert','Sweet',5),
(16,10,'Mexican Food','Burrito',6),
(17,40,'Dessert','Ice Cream',6),
(18,60,'American Fast Food','Crispy Chicken',6),
(19,40,'Italian','Pizza',6)
;
...
END//
Call new_vehicle_insertion(23,'4579','Camry','toyota');
Call new_vehicle_insertion(24,'5668','S2','Tesla');
select * from vehicle;
